...
var CollectionEndpoint = function(){
	...
	BaseCollectionEndpoint.apply(this, [
		log4js.getLogger('restak.scheduler.job-history.CollectionEndpoint'), '/scheduler/jobs/:jobId/history', 'restak.scheduler.JobInstanceQuery']);
...
var ResourceGetEndpoint = function(){
	BaseResourceGetEndpoint.apply(this, [
		log4js.getLogger('restak.scheduler.job-history.endpoints.ResourceGetEndpoint'), '/scheduler/jobs/:jobId/history/:instanceId', 'restak.scheduler.JobInstanceQuery']);
